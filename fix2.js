...
// Ensure the mode is explicitly set to what we expect, though default is runOnceForAllItems.
// Format Memory node should output an array of 1 item

return {
  json: {
    aiInput: $('Edit Fields8').first().json.aiInput,
    senderId: $('Edit Fields8').first().json.senderId,
